...
table_name = 'hotel_reservations.main.Reservations3'

# Output file paths
parquet_file_path = '/Users/jpetrides/Documents/Demo Data/Hotels/Jeeves Idea/data/F_Reservations_temp.parquet'
hyper_file_path = '/Users/jpetrides/Documents/Demo Data/Hotels/Jeeves Idea/data/F_Reservations.hyper'
...
def parquet_to_hyper():
    ...
    with HyperProcess(telemetry=Telemetry.SEND_USAGE_DATA_TO_TABLEAU) as hyper:
        ...
        with Connection(endpoint=hyper.endpoint,
            ...
            connection.execute_command(f"CREATE TABLE F_Reservations AS (SELECT * FROM external('{parquet_file_path}'))")
